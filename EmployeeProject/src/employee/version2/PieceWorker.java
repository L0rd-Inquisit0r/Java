...
public class PieceWorker extends Employee {
	...
	public PieceWorker(int empID, String empName, LocalDate empDateHired, LocalDate empBirthDate,
	...
	public PieceWorker(int empID, String empName, int totalPiecesFinished, float ratePerPiece) {
		super(empID, empName);
		this.totalPiecesFinished = totalPiecesFinished;
		this.ratePerPiece = ratePerPiece;
	}
	...
	public PieceWorker(int empID, String empName) {
		super(empID, empName);
	}
    ...
    public String toString()
    {
        ...
        String info=String.format("ID: %d\nNAME: %s\nDate Hired: %s\nDate of Birth: %s\nTotal Pieces Finished: %d\nRate per Piece:%.2f",
                super.getEmpID(),super.getEmpName(),dateHired,dateBirth,this.totalPiecesFinished,this.ratePerPiece);
